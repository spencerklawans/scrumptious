...
color: #000000;">
 ...
 <vaadin-horizontal-layout style="height: 100%; font-style: normal; font-weight: 500; font-size: 36px; line-height: 42px; color: #FFFFFF; align-self: flex-start; width: 100%; justify-content: space-around; flex-grow: 0;">
  <vaadin-vertical-layout style="background: #00758B; border: 1px solid rgba(0, 0, 0, 0.5); box-sizing: border-box; border-radius: 10px; margin-left: var(--lumo-space-xl); margin-right: var(--lumo-space-xl); justify-content: flex-start; height: 100%; margin-top: var(--lumo-space-l); margin-bottom: var(--lumo-space-l); width: 30%;" id="todo">
   <vaadin-button style="color: #FFFFFF; background-color: #00758B; font-size: 18pt; margin-bottom: auto;" disabled tabindex="">
     To Do 
   </vaadin-button>
   <vaadin-vertical-layout id="todoWrapper" style="width: 100%; flex-grow: 1; flex-shrink: 1; justify-content: flex-start; padding: var(--lumo-space-s);"></vaadin-vertical-layout>
  </vaadin-vertical-layout>
  <vaadin-vertical-layout style="height: 100%; background: #009FB7; border: 1px solid rgba(0, 0, 0, 0.5); box-sizing: border-box; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 10px; font-family: Roboto; font-style: normal; font-weight: 500; font-size: 36px; line-height: 42px; margin: var(--lumo-space-l); margin-left: var(--lumo-space-xl); margin-right: var(--lumo-space-xl); width: 30%;" id="inProgress">
   <vaadin-button style="color: #FFFFFF; background-color: #009FB7; font-size: 18pt; margin-bottom: auto;">
     In Progress 
   </vaadin-button>
   <vaadin-vertical-layout id="progressWrapper" style="width: 100%; flex-grow: 1; justify-content: flex-start; padding: var(--lumo-space-s);"></vaadin-vertical-layout>
  </vaadin-vertical-layout>
  <vaadin-vertical-layout style="background: #31BCCD; border: 1px solid rgba(0, 0, 0, 0.5); box-sizing: border-box; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 10px; font-family: Roboto; font-style: normal; font-weight: 500; font-size: 36px; line-height: 42px; margin: var(--lumo-space-l); height: 100%; margin-right: var(--lumo-space-xl); margin-left: var(--lumo-space-xl); width: 30%;" id="completed">
   <vaadin-button style="color: #FFFFFF; background-color: #31BCCD; font-size: 18pt; margin-bottom: auto;">
     Completed 
   </vaadin-button>
   <vaadin-vertical-layout id="completedWrapper" style="width: 100%; flex-grow: 1; justify-content: flex-start; padding: var(--lumo-space-s);"></vaadin-vertical-layout>
  </vaadin-vertical-layout>
