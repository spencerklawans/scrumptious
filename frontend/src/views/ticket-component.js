...
<vaadin-vertical-layout style="border: 2px solid #000000; background-color: #FFFFFF; justify-content: space-between; margin: var(--lumo-space-xs);">
 <vaadin-button id="title" style="width: 100%; background-color: rgba(255, 255, 255); font-size: 14pt; flex-grow: 1; color: #000000; font-weight: bold;" disabled tabindex=""></vaadin-button>
 <vaadin-horizontal-layout style="align-self: center;">
  <vaadin-button style="background-color: #FFFFFF; color: #000000; font-size: 12pt; font-weight: bold; padding: var(--lumo-space-xs);" disabled tabindex="">
   Due :
  </vaadin-button>
  <vaadin-button id="dateButton" style="background-color: #FFFFFF; color: #000000; font-size: 12pt; padding: var(--lumo-space-xs);" disabled tabindex="">
    Button 
  </vaadin-button>
